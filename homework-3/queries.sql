...
WHERE units_in_stock < 25 AND discontinued != 1
AND categories.category_name IN ('Dairy Products','Condiments')
ORDER BY units_in_stock;

-- 3. Список компаний заказчиков (company_name из табл customers), не сделавших ни одного заказа
--Получаем данные из таблицы customers соединяем ее join с таблицей orders и в фильтровке проверяем что order_id null
